...
export default function DiaryResultPage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#fff7d6_0%,_#d1fae5_28%,_#e0f2fe_64%,_#f8fafc_100%)] px-4 py-6">
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] max-w-xl flex-col items-center justify-center gap-8">
        ...
        <div className="w-full rounded-[2rem] border border-white/80 bg-white/90 p-6 text-center shadow-[0_24px_80px_rgba(15,23,42,0.14)]">
        ...
        <button
          ...
          className="rounded-[1.4rem] bg-amber-300 px-8 py-4 text-xl font-black text-slate-900 shadow-[0_16px_40px_rgba(251,191,36,0.28)] transition hover:bg-amber-200"
        >
          다시 스캔하기
        </button>
      </div>
